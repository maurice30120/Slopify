...
**What to build:** Réviser les commentaires existants du streaming des pensées et des réponses pour rendre explicites la transition de phase, la prévention des duplications et le choix entre rendu Markdown par blocs et texte brut selon le flux du terminal.
